...
public class endevinaColor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet endevinaColor</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet endevinaColor at " + request.getContextPath() + "</h1>");
            ...
            if (colorInicial.toLowerCase().equals(colorUsuari.toLowerCase())) {
                endevinat = "Felicitats! Has endevinat el color.";
            }
            out.println("<h1>" + endevinat + "</h1>");
            out.println("<a href='indexColores.html'>Tornar a intentar<a/>");
