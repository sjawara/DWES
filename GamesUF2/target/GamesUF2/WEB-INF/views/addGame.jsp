            ...
            <form:form modelAttribute="newGame" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <form:input id="empresa" path="empresa" type="text" class="form:input-large"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <form:input id="limitDownload" path="limitDownload" type="text" class="form:input-large"/>
                        </div>
                    </div>                     
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <form:input id="plataforma" path="plataforma" type="text" class="form:input-large"/>
                        </div>
                    </div>   
